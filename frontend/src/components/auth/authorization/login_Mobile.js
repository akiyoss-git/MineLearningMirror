...
class Login_Component_Mobile extends Component {
    constructor(props) {
        super(props);
            ...
            <div className="cont">
                <Container className="login-m">
                    ...
                    <Form className="form" onSubmit={(e) => this.handleSubmit(e)}>
                        ...
                        <Button>Войти</Button>
                        <div className="reglink">Нет аккаунта? <a href="/signup">Зарегистрируйся сейчас</a></div>
                    </Form>
                </Container>
            </div>
        )
...
export default Login_Component_Mobile;
