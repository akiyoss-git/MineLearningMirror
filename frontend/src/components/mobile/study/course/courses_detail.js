                ...
                new: 
                    <>
                        <div className="block-m">
                            <div className="title-m"><h4>{response.data.title}</h4></div>
                            <div className="text-m"><h5>{response.data.preview}</h5></div>
                            <div className="line-m">{response.data.content}</div>
                            <div className="picdiv-m"><img className="pic" src={response.data.poster} /></div>
                        </div>
